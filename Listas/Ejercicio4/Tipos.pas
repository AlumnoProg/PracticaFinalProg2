...
Valor2: Pointer; // Puntero Generico a Cualquier cosa (dato primitivo, otra estructura, un objobjeto, etc.)
// Comportamiento basico del <TipoElemento>
Function ArmarString(): String; // Retorno la Clave como un String
Function TipoDatoClave(avClave: Variant): TipoDatosClave; // Valida el tipo de dato de la clavclave
...
Procedure Inicializar(aTDC: TipoDatosClave; aValor1Inicial: Variant); // Para inicilizar segunel dato clave
End;
